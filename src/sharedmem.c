...
void shm_init_general(int size){
	...
	general_shm_mutex = general_shm_ptr;
	general_shm_mutexattr = general_shm_ptr + sizeof(pthread_mutex_t);
	general_shm_pos = general_shm_ptr + sizeof(pthread_mutex_t) + sizeof(pthread_mutexattr_t);
	...
	*general_shm_pos = (sizeof(int) + sizeof(pthread_mutex_t) + sizeof(pthread_mutexattr_t));
	printf("DONE\n");
}
...
int shm_get_general(int size){
	...
	*general_shm_pos = *general_shm_pos + size;
